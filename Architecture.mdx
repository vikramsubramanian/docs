...
+ Mayil **does not train or fine-tune** foundational models. It simply uses them as tool for semantic understanding and natural language processing.
+ Mayil has a custome code ingestion mechanism that builds an abstract syntax tree of the code and indexes data using the AST to create logically indepenednt knowledge units.
